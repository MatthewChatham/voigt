"""
Frontend layout for Analysis tab.
"""
import inspect
...
from ..common.drawing import emptyplot
from ..common.aggregate import fwhm, composition, peak_position
...
step2 = [html.H1('Step 2: Adjust Chart', style={'margin-left': '10px'}),
         dbc.Row([
             ...
             dbc.Col([
                 ...
                 dbc.Tooltip(html.Div([
                     html.Li(
                         ...
                         'the sum of the areas of ea'
                         'ch individual fitted peak.'),
                     html.Li(
                         'Fitted Peaks: Shows each fitted peak.'),
                     html.Li(
                         'Peak Histogram: Histogram of peak centers.'),
                 ], style={'width': '500px'}),
                     offset=100, placement='bottom-start',
                     autohide=False, target='target',
...
step3 = [html.H1('Step 3: Select Splits', style={'margin-left': '10px'}),
         dbc.Row([
...
step4 = [html.H1('Step 4: Generate File', style={'margin-left': '10px'}),
         dbc.Row([
             ...
             dbc.Col([
                 ...
                 dbc.Card(dbc.CardBody([
                     ...
                     html.P('The output file will compute 3 aggregations'
                            'for each region defined by'
                            ' the selected split points.'),
                     html.P(
                         'Click the text of the definiti'
                         'ons below to view Python code.'),
                     dbc.ListGroup([
                         dbc.ListGroupItem([
                             html.Span('Full Width Half Maxi'
                                       'mum: Given a region, the'
                                       ' FWHM of the sum of fitted peaks with '
                                       'centers in the region.',
                                       id='collapse-button1',
                                       style={'cursor': 'pointer'}),
                             dbc.Collapse(
                                 dbc.Card(dbc.CardBody(fwhm_tooltiptext),
                                          style={
                                     'margin': '10px'}),
                                 id="collapse1",
                             ),
                         ...
                         dbc.ListGroupItem([
                             html.Span(
                                 'Composition: Total area of'
                                 ' peaks with centers in the region.',
                                 id='collapse-button2',
                                 style={'cursor': 'pointer'}),
                             dbc.Collapse(
                                 dbc.Card(dbc.CardBody(comp_tooltiptext),
                                          style={
                                     'margin': '10px'}),
                                 id="collapse2",
                             ),
                         ...
                         dbc.ListGroupItem([
                             html.Span('Weighted Average Peak '
                                       'Position: Average of peak centers'
                                       ' in the region, weighted by '
                                       'their total area (not '
                                       'just area in that region).',
                                       id='collapse-button3',
                                       style={'cursor': 'pointer'}),
                             dbc.Collapse(
                                 dbc.Card(dbc.CardBody(wapp_tooltiptext),
                                          style={
                                     'margin': '10px'}),
                                 id="collapse3",
                             ),
                 ...
                 dbc.Card(dbc.CardBody([
                     ...
                     dbc.ListGroup([
                         dbc.ListGroupItem([
                             html.Span('Click to view columns.'
                                       ' Each row is a file.',
                                       id='collapse-button4',
                                       style={'cursor': 'pointer'}),
                             dbc.Collapse(
         ...
         dbc.Row([
             ...
             dbc.Col([html.A(dbc.Button('Download CSV',
                                        color='success',
                                        style={'font-size': '16px',
                                               'margin': '10px 5px 0 0'}),
                             href='/dash/download', id='dl_link'),
                      html.A(dbc.Button('Download Images',
                                        color='success',
                                        style={'font-size': '16px',
                                               'margin': '10px 5px 0 0'}),
...
analysis = step1 + step2 + step3 + step4
